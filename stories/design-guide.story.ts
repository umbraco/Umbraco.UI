...
const propertiesArray = Object.keys(customProperties.customProperties).map(
  // @ts-ignore:
  key => ({ key: key, value: customProperties.customProperties[key] })
);

const copyIcon = svg`<svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-copy js-clipboard-copy-icon m-2">
