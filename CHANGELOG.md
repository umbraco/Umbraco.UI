...
- **button:** prevent click handler from firing when disabled ([#1417](https://github.com/umbraco/Umbraco.UI/issues/1417)) ([4314074](https://github.com/umbraco/Umbraco.UI/commit/4314074062b348ca207a6354a7d17ade2b67cdfe))
- **Combobox:** Clear three SonarCloud maintainability smells ([#1422](https://github.com/umbraco/Umbraco.UI/issues/1422)) ([34ca8be](https://github.com/umbraco/Umbraco.UI/commit/34ca8be3eca9a8dde51cfb922087b9bc4d95cb99))
- Form control mixin: handle late changed value ([#1445](https://github.com/umbraco/Umbraco.UI/issues/1445)) ([609fef1](https://github.com/umbraco/Umbraco.UI/commit/609fef133d59a30d570038936ef877f5da42dcde))
- **form-control:** restore v1 UUIFormControlMixin name and surface ([#1444](https://github.com/umbraco/Umbraco.UI/issues/1444)) ([c37aeaf](https://github.com/umbraco/Umbraco.UI/commit/c37aeaf378b3f710321f143698698c4e68706c3d)), closes [#1287](https://github.com/umbraco/Umbraco.UI/issues/1287)
- Prevent long names from pushing action buttons out of view ([#1415](https://github.com/umbraco/Umbraco.UI/issues/1415)) ([e917f2f](https://github.com/umbraco/Umbraco.UI/commit/e917f2f3d02c03bf9daee406576394d355667ac5))
- resolve SonarCloud script issues (command injection + duplicate branch) ([71342a9](https://github.com/umbraco/Umbraco.UI/commit/71342a94191caac102dec30a80b222ff89bd7c0a))
- **scripts:** launder coverage arg through component folder allowlist ([d1d8a85](https://github.com/umbraco/Umbraco.UI/commit/d1d8a858760613175597e7dd5243d96fc7902bcb))
- **scripts:** run vitest without a shell in test-coverage-package ([638be76](https://github.com/umbraco/Umbraco.UI/commit/638be76c7b8104a3acaa05c4745dc1eae9f40a33))
- **storybook-readme:** clear sonar smells in the readme panel ([a09aa9a](https://github.com/umbraco/Umbraco.UI/commit/a09aa9ad1bb394159fdc36d211acb3cdedaf8ea0))
- **styles:** move text-rendering out of [@font-face](https://github.com/font-face) to .uui-font ([d1a9c45](https://github.com/umbraco/Umbraco.UI/commit/d1a9c45496a222e3508f69b6e6f1a043adb66b78))
- Tag in picker search results wrap on multiple lines ([#1423](https://github.com/umbraco/Umbraco.UI/issues/1423)) ([3c8233a](https://github.com/umbraco/Umbraco.UI/commit/3c8233aa769448c28adfca61397ddde88b189c5c))
- Tag in picker search results wrap on multiple lines ([#1423](https://github.com/umbraco/Umbraco.UI/issues/1423)) ([74dd520](https://github.com/umbraco/Umbraco.UI/commit/74dd52046acfc692055527f8b07f33ded1c811e1))
- **Textarea:** hover state + adjust padding to align with input ([#1413](https://github.com/umbraco/Umbraco.UI/issues/1413)) ([4719953](https://github.com/umbraco/Umbraco.UI/commit/47199533cc0242d72506827667c38d903068cbdd))
- **slider:** forward the autocomplete attribute to the native input ([cb0eaf4](https://github.com/umbraco/Umbraco.UI/commit/cb0eaf48691c1f0129c9aa0b3fbe32ddcc35166f))
...
- feat!: replace --uui-show-focus-outline JS with :focus-visible CSS ([2c1bc07](https://github.com/umbraco/Umbraco/commit/2c1bc074dbce25ae340967966a37351b44ec87d7))
- feat(base)!: remove element-internals-polyfill (#1281) ([6c30deb](https://github.com/umbraco/Umbraco/commit/6c30deb040b58b21b09d20779f96c66d25e86bb1)), closes [#1281](https://github.com/umbraco/Umbraco/issues/1281)
- feat(caret)!: remove deprecated uui-caret component (#1279) ([50707b2](https://github.com/umbraco/Umbraco/commit/50707b2ac87d98ed9b73fc7b6cc2108f059d72c4)), closes [#1279](https://github.com/umbraco/Umbraco/issues/1279)
- feat(popover)!: remove deprecated uui-popover component (#1280) ([2ad31d8](https://github.com/umbraco/Umbraco/commit/2ad31d8b87999fb2015389f2053e69e673058e90)), closes [#1280](https://github.com/umbraco/Umbraco/issues/1280)
- feat(base)!: remove deprecated non-UUI-prefixed class aliases (#1276) ([89d95a9](https://github.com/umbraco/Umbraco/commit/89d95a9eba78d9a6df5791c2caadd46b03df2b96)), closes [#1276](https://github.com/umbraco/Umbraco/issues/1276)

### Bug Fixes

- **a11y:** Add aria-hidden attribute to svg icon when creating a new element ([#1326](https://github.com/umbraco/Umbraco/issues/1326)) ([09b8125](https://github.com/umbraco/Umbraco/commit/09b81253543a1bf700c3c8e717df144eb95c5ef0))
- add .js extensions to all relative imports and enforce via ESLint ([356c45c](https://github.com/umbraco/Umbraco/commit/356c45c6614771b5ec95aee4666463a90c3d8786))
- add readonly to 3 [@state](https://github.com/state)() members incorrectly accepted as false positives (S2933) ([0d5a0cc](https://github.com/umbraco/Umbraco/commit/0d5a0ccfc73e34e4eba1e5fac9d59ae262554a98))
- add readonly to never-reassigned class members (S2933) ([#1320](https://github.com/umbraco/Umbraco/issues/1320)) ([43b76c1](https://github.com/umbraco/Umbraco/commit/43b76c1b2de0467b10eec1d9e807e19a8e42babd))
- add sideEffects field for proper tree-shaking ([#1308](https://github.com/umbraco/Umbraco/issues/1308)) ([240ddb1](https://github.com/umbraco/Umbraco/commit/240ddb13a9833078c1f2373bdcfab59ccda2f18d))
- adds export of new component ([518ebc3](https://github.com/umbraco/Umbraco/commit/518ebc31d21e6400d3c36c0dbbee1124111df76b))
...
- **avatar:** use Lit when() directive instead of negated condition ([326cdfd](https://github.com/umbraco/Umbraco/commit/326cdfdacd6bccdf263c3471084d5aabcd122717))
- **base,icon-registry:** replace unsafe Function type with explicit signatures ([#1273](https://github.com/umbraco/Umbraco/issues/1273)) ([c27b8f7](https://github.com/umbraco/Umbraco/commit/c27b8f7cbe30342eb79139a711c475999f96791b))
- **base:** clear ElementInternals validity without anchor per spec ([ade70e3](https://github.com/umbraco/Umbraco/commit/ade70e37c384884c45a8db00a4118d65b163852e))
- **base:** remove [@ts-ignore](https://github.com/ts-ignore) for Popover API ([e0c833a](https://github.com/umbraco/Umbraco/commit/e0c833ac999ebdbfe99323be89281be9293295cb))
- **breadcrumbs:** use .at(-1) instead of [length - 1] (S7755) ([f308ff1](https://github.com/umbraco/Umbraco/commit/f308ff1ca79b7e19df93cbfc76020d786a71539e))
- **button-copy-text:** import registration file in story ([690e68f](https://github.com/umbraco/Umbraco/commit/690e68f5000adac070e6c0d77bc4e681053c7099))
- **button:** remove requestSubmit fallback ([#1283](https://github.com/umbraco/Umbraco/issues/1283)) ([a23389d](https://github.com/umbraco/Umbraco/commit/a23389d4f1256b23d71b7d4dfeec4155ca7d7e4a))
...
- **card:** assert shadow DOM elements exist before clicking in tests ([7f50c11](https://github.com/umbraco/Umbraco/commit/7f50c11eb7453e4c4f41926a6f8a3496804bce66))
...
- **ci:** use project_analyses API for SonarCloud version events ([8e2e4d7](https://github.com/umbraco/Umbraco/commit/8e2e4d7ca6de1908d503608fbb2687fb9144f9ca))
- **ci:** use specific version for SonarCloud new code baseline ([8e3af5b](https://github.com/umbraco/Umbraco/commit/8e3af5b91e63ee5fd06cf5d47d57b5f2f6be0d71))
- **codemod:** address review feedback from Copilot ([76d0335](https://github.com/umbraco/Umbraco/commit/76d0335f12d20d2cdb51dc9df73d5da6ce91b386))
- **codemod:** address SonarQube code smells ([677caa7](https://github.com/umbraco/Umbraco/commit/677caa779fecb5793f4820d70a3b51abac5d63ba))
- **codemod:** match font path without trailing slash ([13cc828](https://github.com/umbraco/Umbraco/commit/13cc8280cd288ec8b6e367399b700a2d1f1fabe9))
- **codemod:** skip files with no UUI imports to prevent formatting noise ([c79e514](https://github.com/umbraco/Umbraco/commit/c79e5149eeb3c0adc3aab49d9d9aebc286d43e17))
- Color swatch contrast ([#1207](https://github.com/umbraco/Umbraco/issues/1207)) ([0712624](https://github.com/umbraco/Umbraco/commit/0712624974ec122a784717e3714ab4b51ddf804d))
- **color-picker:** correct hsv format output, reset \_color on empty value ([afaf054](https://github.com/umbraco/Umbraco/commit/afaf0540067d1b519868fda94b1a962c5be3b56b))
- **color-picker:** externalize colord dependency ([#1309](https://github.com/umbraco/Umbraco/issues/1309)) ([1caf034](https://github.com/umbraco/Umbraco/commit/1caf0340844ff7aef535d772812e16bf938fc3a1))
- **color-picker:** round s/l to integers; fix HSV saturation in getFormattedValue ([c0572ae](https://github.com/umbraco/Umbraco/commit/c0572ae8982999201c026c870a78aa78b354a205))
- **color-slider,color-picker:** fix pre-existing CSS syntax and reactivity bugs ([145c7b3](https://github.com/umbraco/Umbraco/commit/145c7b382f4babf4c4fe6b9c65faf3fc6520dc77)), closes [#updateGradients](https://github.com/umbraco/Umbraco/issues/updateGradients)
- **color-swatch:** restore background style on color div ([003163b](https://github.com/umbraco/Umbraco/commit/003163b903465a604dbde11574ae85236fe63f8f))
- **color:** add alpha NaN guard, clarify alpha convention in JSDoc ([7f7aa72](https://github.com/umbraco/Umbraco/commit/7f7aa729ad2c4079548c5017f8b8b9d6deb974c6))
- **color:** address SonarQube issues in color utilities (S7773, S6594, S5843, S7735) ([e51834e](https://github.com/umbraco/Umbraco/commit/e51834eadc2af430228520e5b819751c62dee3af))
- **color:** fix slider dead code, fix swatch contrast reactivity, add tests ([5ddfd41](https://github.com/umbraco/Umbraco/commit/5ddfd413be09c3c7067ba9e24735c56ca7f500d5))
- **color:** normalise hue to [0,360); guard value setter against parse failure ([8a4f1f8](https://github.com/umbraco/Umbraco/commit/8a4f1f83b800d98c11cf2122fcc09520d03a41ad))
- correct README imports in migrated story files ([ac343d2](https://github.com/umbraco/Umbraco/commit/ac343d20ef3fe475adeae1a77e2d57dea77c7def))
- **css:** resolve uui-css.css import for test runner ([b18daec](https://github.com/umbraco/Umbraco/commit/b18daec202983611bd914ef572dae4c189e26b04))
- **css:** resolve uui-text.css import for Storybook ([dc2e62c](https://github.com/umbraco/Umbraco/commit/dc2e62c012e128ea96effb9b4a469d4b9f9a217e))
- fixes typings for storybook ([f092f9b](https://github.com/umbraco/Umbraco/commit/f092f9b279584f5cedf63b2c1de11b81840642c9))
- format color-picker query property to satisfy prettier line length ([de3f244](https://github.com/umbraco/Umbraco/commit/de3f2448e8cbb91a4305bb84d6073dd8d7769168))
- format combobox-async-example to satisfy prettier line length ([d4de3c0](https://github.com/umbraco/Umbraco/commit/d4de3c0c6faf83f69dc42ca75f933f7b34d3333b))
- include src/ patterns in sideEffects for Storybook builds ([442671c](https://github.com/umbraco/Umbraco/commit/442671ce0e340a9f64c071f23c67e6fc04c346f9))
- **popover-container:** replace nested ternary with if/else (S3358) ([6a47d48](https://github.com/umbraco/Umbraco/commit/6a47d486c1d0ebc31236f2ed1502173a2d0b0e94))
- **radio-group:** remove [@ts-ignore](https://github.com/ts-ignore) by widening event listener type ([f91a7b9](https://github.com/umbraco/Umbraco/commit/f91a7b920728e1094425e9252506c76a10001cf2)), closes [#onSelectClick](https://github.com/umbraco/Umbraco/issues/onSelectClick)
- remove dead assignment and use new Array() in UmbracoWordGenerator ([8331629](https://github.com/umbraco/Umbraco/commit/8331629fd0c58552f75ac01acbc10f4f53aa6a75))
- remove unnecessary object/array spread in 22 files (S7747) ([8234b4b](https://github.com/umbraco/Umbraco/commit/8234b4bab67f779876d1ed3f21b0364b0899633b))
- resolve 16 SonarCloud issues across 10 files ([132579c](https://github.com/umbraco/Umbraco/commit/132579c115418d1c48801111b3b9dc81855a5975))
- resolve 20 SonarCloud issues across 11 files ([89635fe](https://github.com/umbraco/Umbraco/commit/89635fe09c1f245a236728311d2cf0d5d320cc01))
- resolve 34 SonarCloud issues across 32 files ([8958fa5](https://github.com/umbraco/Umbraco/commit/8958fa5831d934342cf4d1da997fd6e063c809ea))
- resolve 6 test TODOs across 5 components ([#1321](https://github.com/umbraco/Umbraco/issues/1321)) ([612284b](https://github.com/umbraco/Umbraco/commit/612284bf5bd83b150f0fbb5ba557d88076fb93b0)), closes [#label-button](https://github.com/umbraco/Umbraco/issues/label-button)
- resolve 7 SonarCloud issues on main branch ([#1318](https://github.com/umbraco/Umbraco/issues/1318)) ([89ccd24](https://github.com/umbraco/Umbraco/commit/89ccd2478a57c3b8bfa7f71f4fe5604e2efb7282))
- resolve remaining S7735 issues and fix file-preview/toast-container bugs ([#1323](https://github.com/umbraco/Umbraco/issues/1323)) ([de7bdb9](https://github.com/umbraco/Umbraco/commit/de7bdb94028c9a68dafd57838bc5423f23b57ec0)), closes [#private](https://github.com/umbraco/Umbraco/issues/private) [#private](https://github.com/umbraco/Umbraco/issues/private) [#file](https://github.com/umbraco/Umbraco/issues/file) [#file](https://github.com/umbraco/Umbraco/issues/file)
- resolve S7764, S7735, and S3358 SonarCloud issues across 19 files ([#1322](https://github.com/umbraco/Umbraco/issues/1322)) ([46616ff](https://github.com/umbraco/Umbraco/commit/46616ffa1560f00033ee84de3a4b970acc6867dd))
...
- **responsive-container:** guard against stale ResizeObserver callbacks ([f94664a](https://github.com/umbraco/Umbraco/commit/f94664a02262af5995243e4788a1d05454442c45)), closes [#isConnected](https://github.com/umbraco/Umbraco/issues/isConnected)
- **storybook:** add default value for CSS custom properties in manifest ([7595ef7](https://github.com/umbraco/Umbraco/commit/7595ef7c005f019711c2e25e4e2f2362fe95c636))
- **storybook:** use color type for CSS custom properties matching color pattern ([3c57342](https://github.com/umbraco/Umbraco/commit/3c573421e6372a07ff59f9083e4f2594442a0080))
- **storyhelpers:** guard against undefined CSS custom property values ([292a2ae](https://github.com/umbraco/Umbraco/commit/292a2ae6b874b7b6ab00de688203074589ef9c88))
- **symbol-file-thumbnail:** fall back to icon when image fails to load ([555d029](https://github.com/umbraco/Umbraco/commit/555d0294bdeb408b62234ada183b8e952e65fc7d))
- **test:** replace property-based Chai assertions with function calls ([#1295](https://github.com/umbraco/Umbraco/issues/1295)) ([a3aae06](https://github.com/umbraco/Umbraco/commit/a3aae069e87bf3427179c9bd1e7a10c2c88f6d5e)), closes [AB#65184](https://github.com/AB/issues/65184)
- **themes:** extract shared foundations into base.css ([#1311](https://github.com/umbraco/Umbraco/issues/1311)) ([98c1f47](https://github.com/umbraco/Umbraco/commit/98c1f47227ea0868e0a59264e38c8e0f885089bb))
- **timer:** adjust remaining proportionally when duration changes ([#1324](https://github.com/umbraco/Umbraco/issues/1324)) ([4847e8e](https://github.com/umbraco/Umbraco/commit/4847e8e5097d40902ff83b5d09c925ff287ec72d))
- use Number.isNaN, Number.parseFloat, Number.parseInt over globals ([798e588](https://github.com/umbraco/Umbraco/commit/798e588f49f0181d4d5310962944982a44d2616c))
...
- `uui-symbol-drag-handle` component ([#1118](https://github.com/umbraco/Umbraco/issues/1118)) ([73fffad](https://github.com/umbraco/Umbraco/commit/73fffad17757cfb02738fcf64ceae49476feaffb))
- add @umbraco-ui/codemod package for automated v1→v2 migration (AB[#65024](https://github.com/umbraco/Umbraco/issues/65024)) ([a445420](https://github.com/umbraco/Umbraco/commit/a445420a98ccc7770516435937c34e3a4cf4e76f))
- add jscodeshift codemod for v1→v2 import migration (AB[#65024](https://github.com/umbraco/Umbraco/issues/65024)) ([1eda56a](https://github.com/umbraco/Umbraco/commit/1eda56ae020617b9e1317e12a41c0a51cbba459e))
- add runtime version detection and duplicate-load warnings ([#1302](https://github.com/umbraco/Umbraco/issues/1302)) ([e84194c](https://github.com/umbraco/Umbraco/commit/e84194cdfc921fb3755960a15ee193a4bdf3f62a))
- add Storybook support for src/ components ([8432df1](https://github.com/umbraco/Umbraco/commit/8432df1dee2214a4c6bbea2754a77b5e6da125cd)), closes [AB#65021](https://github.com/AB/issues/65021)
...
- **codemod:** rewrite uui-css dist paths and <link> tags ([93a89f0](https://github.com/umbraco/Umbraco/commit/93a89f0af327574815a9533bfd6bc66d01b4175b))
- **color-picker,color-swatch:** add interactive Storybook stories ([96baa05](https://github.com/umbraco/Umbraco/commit/96baa050d234551da004abc28f26ea4c02fd3c47))
- **color:** implement color utilities backed by culori ([ddda203](https://github.com/umbraco/Umbraco/commit/ddda203241ee18697f0a4a57c584f035088ac453))
- **css:** introduce themes/ directory with light and dark theme ([f77c2c5](https://github.com/umbraco/Umbraco/commit/f77c2c5bbe5db415ec8b4e7db89f6bd1cd3386d2))
- **Form Control:** V2 based on Backoffice version ([#1287](https://github.com/umbraco/Umbraco/issues/1287)) ([c53b9c8](https://github.com/umbraco/Umbraco/commit/c53b9c805c725340cd0ac4dbcfe8ce25952ac434)), closes [#runValidatorsCallback](https://github.com/umbraco/Umbraco/issues/runValidatorsCallback)
- migrate dialog, dialog-layout, table and add design stories ([94a99d7](https://github.com/umbraco/Umbraco/commit/94a99d71eecd3669d8ff967cd20364543ba06810))
- port release/2.0 changes (lit v3, FormControlMixin fix, input tests) ([268201e](https://github.com/umbraco/Umbraco/commit/268201edd50f61c1d6d3640b642f8f307f1f9e0f))
- single-package architecture spike (AB[#65021](https://github.com/umbraco/Umbraco/issues/65021)) ([731b142](https://github.com/umbraco/Umbraco/commit/731b142cee9d8c83f94585b9a63ae696b24c22ed))
- update build tool dependencies to latest major versions ([#1275](https://github.com/umbraco/Umbraco/issues/1275)) ([ae9491b](https://github.com/umbraco/Umbraco/commit/ae9491ba42c24caa87f78e6c8f1216db577bb2b1))
- update eslint to v10 ([#1278](https://github.com/umbraco/Umbraco/issues/1278)) ([bdb1292](https://github.com/umbraco/Umbraco/commit/bdb12924ee2e3ed7b63c32350e7058c278d25e45))
- Update general styling attributes for UI Library 2.0 ([#1237](https://github.com/umbraco/Umbraco/issues/1237)) ([9b5e28e](https://github.com/umbraco/Umbraco/commit/9b5e28ec8688effb8de7a34703dbd415f49abb58))
- update lit to v3 ([c0a62a9](https://github.com/umbraco/Umbraco/commit/c0a62a9f6fb7017b59d314c0c5d466f3281662bd))

### Performance Improvements

- hoist PostCSS config resolution in processLitCSSPlugin ([09feed2](https://github.com/umbraco/Umbraco/commit/09feed2131ca63f0699ac94f4afd5354397d9ec6))
