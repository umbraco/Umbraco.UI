              ...
              <span
                ...
                <!----><span ng-if="svgString" ng-bind-html="svgString"
                  ><svg
                    ...
                    viewBox="0 0 512 512">
                    <path
                      d="M348.842 268.008v30.672h59.451v91.495h-304.42V298.68h59.484v-30.672H73.23v152.807h365.737V268.008h-90.125zm25.343-78.879h-77.666V90.827h-82.768v98.302h-77.632l119.033 144.245 119.033-144.245z"></path></svg></span
                ><!---->
                <!---->
              </span>
              ...
              <span
                ...
                <!----><span ng-if="svgString" ng-bind-html="svgString"
                  ><svg
                    ...
                    viewBox="0 0 512 512">
                    <path
                      d="M343.37 94.976c-42.628 0-82.753 17.632-87.626 59.189-4.857-41.558-44.981-59.189-87.64-59.189-45.962 0-78.255 49.901-78.255 96.14 0 105.434 166.958 225.643 166.958 225.643S421.64 296.549 421.64 191.115c0-46.238-32.277-96.139-78.27-96.139z"></path></svg></span
                ><!---->
                <!---->
              </span>
              <strong>59</strong>
