...
import { UUIRefNodeUserElement } from './ref-node-user.element';
import './ref-node-user.js';
...
describe('UUIRefNodeUserElement', () => {
  ...
  beforeEach(async () => {
    element = render(html`
      <uui-ref-node-user name="User"></uui-ref-node-user>
    `).container.querySelector('uui-ref-node-user')!;
