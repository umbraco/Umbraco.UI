import '../icon-registry/uui-icon-registry.element';
import './uui-icon.element';
...
import type { UUIIconRegistryElement } from '../icon-registry/uui-icon-registry.element';
import { LitElement } from 'lit';

import type { UUIIconElement } from './uui-icon.element';
