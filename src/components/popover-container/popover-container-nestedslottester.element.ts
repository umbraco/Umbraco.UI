...
class UUIPopoverContainerScrollLevelElement extends LitElement {
  render() {
    return html`
...
export class UUIPopoverContainerScrollLevel1Element extends UUIPopoverContainerScrollLevelElement {
...
export class UUIPopoverContainerScrollLevel2Element extends UUIPopoverContainerScrollLevelElement {
  static override readonly styles = css`
    .scroll-host {
      height: 180px;
      overflow: auto;
...
export class UUIPopoverContainerScrollLevel3Element extends UUIPopoverContainerScrollLevelElement {
  static override readonly styles = css`
    .scroll-host {
      height: 160px;
      overflow: auto;
