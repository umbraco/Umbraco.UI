...
import './uui-icon-registry-essential.element';
import '../icon/uui-icon.element';
import type { UUIIconRegistryEssentialElement } from './uui-icon-registry-essential.element';
import type { UUIIconElement } from '../icon/uui-icon.element';
